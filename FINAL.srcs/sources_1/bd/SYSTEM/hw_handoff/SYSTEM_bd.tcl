...
proc create_root_design { parentCell } {
  ...
  set mStart [ create_bd_port -dir I mStart ]
  ...
  # Create instance: CLK60_0, and set properties
  set block_name CLK60
  set block_cell_name CLK60_0
  if { [catch {set CLK60_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {450} \
   CONFIG.CLKOUT4_USED {true} \
   CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} \
   CONFIG.CLK_OUT1_PORT {clk_1} \
   CONFIG.CLK_OUT2_PORT {clk_200} \
   CONFIG.CLK_OUT3_PORT {clk_25} \
   CONFIG.CLK_OUT4_PORT {clk_450} \
  ...
  # Create port connections
  connect_bd_net -net CLK60_0_clk60 [get_bd_pins CLK60_0/clk60] [get_bd_pins COUNTER_0/in_signal]
  connect_bd_net -net COUNTER_0_PERIOD [get_bd_pins COUNTER_0/PERIOD] [get_bd_pins axi_gpio_0/gpio_io_i]
  ...
  connect_bd_net -net clk_wiz_0_clk_1 [get_bd_pins clk_wiz_0/clk_1] [get_bd_pins mig_7series_0/sys_clk_i]
  connect_bd_net -net clk_wiz_0_clk_25 [get_bd_ports eth_ref_clk] [get_bd_pins clk_wiz_0/clk_25]
  connect_bd_net -net clk_wiz_0_clk_200 [get_bd_pins CLK60_0/clk_in] [get_bd_pins clk_wiz_0/clk_200] [get_bd_pins mig_7series_0/clk_ref_i]
  connect_bd_net -net clk_wiz_0_clk_450 [get_bd_pins COUNTER_0/clk] [get_bd_pins clk_wiz_0/clk_450]
  connect_bd_net -net mStart_1 [get_bd_ports mStart] [get_bd_pins COUNTER_0/start]
